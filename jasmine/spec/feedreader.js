...
$(function() {
    ...
    */
    ...
    describe('The Menu', function() {
        ...
        it('default hide menu is defined', function() {
            ...
            var hideMenu = $('.menu-hidden .slide-menu');
            expect(hideMenu).toBeDefined();
        });
    ...
    describe('Initial Entries', function() {
        ...
        it('loadFeed function is called and completed is defined', function(done) {
            var feedEntry = $('.entry').html();
    ...
    */
    describe('New Feed Selection', function() {
        ...
        it('new feed is loaded by loadFeed function is defined', function(done) {
            loadFeed(0);
